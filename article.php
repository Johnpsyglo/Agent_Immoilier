...
<body class="articles">
    ...
    $afficher = $test->select_where_articles("articles", "*", $articles);

    foreach ($afficher as $articles) {
        var_dump($afficher);
    echo '
    <div >
    ...
    $cherche_auteur = $test -> select_where_auteurs("auteurs", "nom", $ligne['id_auteurs']);
    ...
    $commentaires = $test->select_where_commentaires("commentaires", "*", $articles);
    ...
    $comauteur = $test->select_where_auteurs("auteurs", "*", $coms['id_auteurs']);
