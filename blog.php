...
session_start([
    'cookie_lifetime' => 10, // Durée de vie du cookie sesison en secondes quand la session est inactive
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="login-page">
                                            ...
                                            <div class="form">
                                                    ...
                                                    <form class="login-form" method="POST" action="updade.php" id="update_article'. $cartes['id_articles'] . '">
